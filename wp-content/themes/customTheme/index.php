<?php get_header(); ?>
        ...
        <!-- ========== HEADER ========== -->
        <header class="header main-header parallax-bg" data-parallax="scroll" data-image-src="http://mywp/wp-content/themes/customTheme/images/bg-img-3.jpg" data-speed="0.4" >
        ...
        <!-- ========== FEATURES ========== -->
        <section class="se-section features-section parallax-bg" data-parallax="scroll" data-image-src="http://mywp/wp-content/themes/customTheme/images/bg-img-3.jpg" data-speed="0.4">
