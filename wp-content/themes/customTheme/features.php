...
<html class="no-js" lang="en">
    <head>
        ...
        <!-- ========== PAGE TITLE ========== -->
        <title>SoftEase - Features | Software, Mobile App & SaaS HTML template</title>
            ...
            <div class="container">
                ...
                <div class="outer">
                    <div class="inner text-center">
                        <h1 class="">Your SaaS app is full of features..</h1>
                        <h5 class="">Display them in most user-friendly and attractive way.</h5>
        ...
        <section class="se-section">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-6 se-feature-style-3">
                        <div class="feature-wrap">
