...
<html class="no-js" lang="en">
    <head>
        ...
        <!-- ========== MINIFIED VENDOR CSS ========== -->
        <link rel="stylesheet" href="http://mywp/wp-content/themes/customTheme/styles/vendor.css">
        <link rel="stylesheet" href="http://mywp/wp-content/themes/customTheme/styles/main.css">

        <!-- ========== MODERNIZR ========== -->
    	<script src="http://mywp/wp-content/themes/customTheme/scripts/vendor/modernizr.js"></script>
    </head>
    ...
    <body class="animsition">
        ...
        <header class="header main-header header-style-3" id="circular-particles">
            <div class="primary-trans-bg white-bg">
                <div class="container">
                    ...
                    <div class="outer">
                        <div class="inner">
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    <img src="http://placehold.it/1600x1000?text=SoftEase" alt="" class="img-responsive img-shadow">
                                </div> <!-- end col-md-6 -->
                            </div> <!-- end row -->
                        </div> <!-- end inner -->
                    </div> <!-- end outer -->
